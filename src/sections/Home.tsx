    ...
    <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'space-between',padding:'0 6%',background:bg,position:'relative',overflow:'hidden'}}>
      ...
      <div style={{maxWidth:'560px',position:'relative',zIndex:1}}>
        ...
        <div style={{display:'flex',gap:'16px',marginBottom:'48px'}}>
          ...
          <a href="/cv.pdf" download style={{border:`2px solid ${outlineBorder}`,color:outlineText,padding:'15px 36px',borderRadius:'12px',fontWeight:'700',textDecoration:'none',fontSize:'15px',background:outlineBg}}>
            Download CV
          </a>
        </div>
